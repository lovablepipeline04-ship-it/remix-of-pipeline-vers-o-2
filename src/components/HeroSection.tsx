...
const HeroSection = () => {
  ...
  return (
    <section ref={ref} id="inicio" className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-20 lg:pb-32">
      {/* Background with parallax */}
      <motion.div
        className="absolute inset-0 bg-cover bg-center"
        style={{ backgroundImage: `url(${heroBg})`, y: bgY, scale: bgScale, opacity: 0.2 }}
      />
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="overflow-hidden">
              <motion.h1
                className="text-[clamp(2.5rem,8vw,7rem)] font-black leading-[0.9] tracking-tight text-foreground"
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
            ...
            <div className="overflow-hidden">
              <motion.h1
                className="text-[clamp(2.5rem,8vw,7rem)] font-black leading-[0.9] tracking-tight"
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                transition={{ duration: 1.2, delay: 0.65, ease: [0.22, 1, 0.36, 1] }}
              >
                <span className="text-gradient-red">CRESCIMENTO</span>
              </motion.h1>
            </div>
            <div className="overflow-hidden">
              <motion.h1
              ...
              >
                ACONTECE<span className="text-primary">.</span>
              </motion.h1>
            </div>
            ...
            <motion.p
              ...
              className="text-lg text-muted-foreground max-w-md leading-relaxed mt-10"
            >
            ...
            >
              <MagneticButton
                ...
                className="bg-primary text-primary-foreground px-10 py-5 rounded-full text-base font-semibold shadow-glow hover:shadow-[0_0_60px_-10px_hsl(0_100%_50%_/_0.6)] transition-shadow duration-500 group relative overflow-hidden"
              >
            ...
            <motion.div
              ...
              className="flex gap-12 md:gap-16 mt-14 pt-8 border-t border-border/50"
            >
              {[
                ...
                <div key={stat.label} className="group cursor-default">
                  <motion.span
                    ...
                    className="text-2xl md:text-3xl font-bold text-foreground block"
                  >
                    {stat.value}
                  </motion.span>
          ...
          >
            <form
              ...
              className="bg-card/80 backdrop-blur-xl border border-border/60 rounded-3xl p-8 md:p-10 space-y-6 relative overflow-hidden"
            >
              {/* Subtle glow */}
              <div className="absolute -top-20 -right-20 w-40 h-40 bg-primary/5 rounded-full blur-[80px] pointer-events-none" />

              <div className="relative z-10">
                <h3 className="text-xl font-bold text-foreground mb-1">Fale com a gente</h3>
                <p className="text-sm text-muted-foreground mb-6">Preencha e entraremos em contato</p>
